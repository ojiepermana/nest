...
export class EntityController {
  ...
  async findAll(@Query() filters: EntityFilterDto) {
    return firstValueFrom(this.client.send('entity.findAll', filters));
  }
  ...
  async getRecap(@Query() dto: any) {
    return firstValueFrom(this.client.send('entity.getRecap', dto));
  }
  ...
  async findOne(@Param('id') id: string) {
    return firstValueFrom(this.client.send('entity.findOne', { id }));
  }
  ...
  async create(@Body() dto: CreateEntityDto) {
    return firstValueFrom(this.client.send('entity.create', dto));
  }
  ...
  async update(@Param('id') id: string, @Body() dto: UpdateEntityDto) {
    return firstValueFrom(this.client.send('entity.update', { id, ...dto }));
  }
  ...
  async remove(@Param('id') id: string) {
    return firstValueFrom(this.client.send('entity.remove', { id }));
  }
