...
function checkNestJSVersion() {
  try {
    ...
    if (comparison < 0) {
      ...
      console.log(chalk.yellow('   Update with: npm install @nestjs/core@latest @nestjs/common@latest\n'));
      return false;
    }
...
function main() {
  ...
  if (!allPassed) {
    ...
    console.log(chalk.dim('   Documentation: https://github.com/ojiepermana/nest/tree/main/libs/generator#readme'));
