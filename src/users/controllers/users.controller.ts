...
export class UsersController {
  ...
  @ApiBody({ type: CreateUsersDto })  @Post()
  ...
  @ApiResponse({ status: 200, description: 'Return all userss.', type: [Users] })  @Get()
  ...
  @ApiParam({ name: 'id', type: String, description: 'Users ID' })  @Get(':id')
  ...
  @ApiResponse({ status: 404, description: 'Users not found.' })
  @ApiResponse({ status: 400, description: 'Bad Request.' })
  @ApiParam({ name: 'id', type: String, description: 'Users ID' })
  @ApiBody({ type: UpdateUsersDto })  @Put(':id')
  async update(
    @Param('id') id: string,
  ...
  @ApiResponse({ status: 404, description: 'Users not found.' })
  @ApiParam({ name: 'id', type: String, description: 'Users ID' })  @Delete(':id')
